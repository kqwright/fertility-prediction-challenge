...
# Get education field
  ...
  relig_df = subset(select = c(cr20m041, cr20m042))
  na.omit(relig_df)
  ...
  sm_df = subset(select = c(cs20m267, cs20m277, cs20m280, cs20m281))
  na.omit(sm_df)
  sm_df <- subset(sm_df, 
                     !(is.na(cs20m267) |
                         is.na(cs20m277) |
  ...
  new_df = subset(select = c(cp20l029, cp20l030, cp20l031, cp20l032, cp20l033, cp20l034, cp20l035, cp20l036, cp20l037, cp20l038, cp20l039, 
