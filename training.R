...
model <- logistf (new_child ~ gender_bg*(age+migration+education2+field_edu2+occupation2+income+urban+owner+health+dist_fr_parents+next_child+first_birth+marriage_dur+partner_dur+rela_satisfied+relig1), data = model_df) 
