...
model <- logistf(new_child ~ gender_bg*(age+migration+education+occupation+owner+income+rela_satisfied+health+relig+personality+urban+next_child+first_birth+partner_dur+marriage_dur+field_edu+dist_fr_parents+numb_child+partner+partner_type+housework), data = model_df) 
